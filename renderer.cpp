...
int main() {
    ...
    BRDF BRDFPL(RGB(1, 0, 0));
    BRDF BRDFPR(RGB(0, 1, 0));
    BRDF BRDFL(RGB(0.5, 0.65, 0.8), RGB(0.2, 0.2, 0.2));
    BRDF BRDFR(RGB(), RGB(0.1, 0.1, 0.1), RGB(0.9, 0.9, 0.9), 1.5);
    BRDF fullReflect(RGB(0.09, 0.09, 0.09), RGB(0.9, 0.9, 0.9));
    ...
    auto pBack = make_shared<Plane> (-4, Vector3(0, 0, 1), RGB(0.5, 0.5, 0.5));
